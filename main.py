...
hyperparameters = {
    ...
    'walker2d-medium-v2':            {'lr': 3e-4, 'eta': 1.0,   'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 50, 'num_epochs': 100, 'gn': 1.0,  'top_k': 1},
    ...
    'walker2d-medium-expert-v2':     {'lr': 3e-4, 'eta': 0.5,   'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 10, 'num_epochs': 4000, 'gn': 5.0,  'top_k': 1},
...
def train_agent(env, state_dim, action_dim, max_action, device, output_dir, args):
    ...
    while (training_iters < max_timesteps) and (not early_stop):
        ...
        print('Total Loss:', np.mean(loss_metric['total_loss']))
        print('Min Loss:', np.mean(loss_metric['min_loss']))
        print('L1:', np.mean(loss_metric['l1']))
        print('L2:', np.mean(loss_metric['l2']))
        print('L3:', np.mean(loss_metric['l3']))
        print('L4:', np.mean(loss_metric['l4']))
